...
Future<String> deviceLabel() async {
  ...
  var label = 'AquaGo Driver';
  try {
    final info = DeviceInfoPlugin();
    if (Platform.isAndroid) {
      final a = await info.androidInfo;
      label = 'AquaGo Driver Android - ${a.manufacturer} ${a.model} (SDK ${a.version.sdkInt})';
    } else if (Platform.isIOS) {
      final i = await info.iosInfo;
      label = 'AquaGo Driver iOS - ${i.utsname.machine} (${i.systemVersion})';
    }
  } catch (e) {

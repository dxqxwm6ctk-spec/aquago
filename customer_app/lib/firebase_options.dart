// إعدادات Firebase لتطبيق الزبون — مشروع aqua-go-7cdd9.
//
// يقابل ما يولّده `flutterfire configure`، وقيمه منسوخة من الملفين
// الرسميين المنزَّلين من الكونسول:
//   android/app/google-services.json   (jo.aquago.customer)
//   ios/Runner/GoogleService-Info.plist (jo.aquago.customer)
//
...
class DefaultFirebaseOptions {
  ...
  static FirebaseOptions get currentPlatform {
    ...
    switch (defaultTargetPlatform) {
      ...
      case TargetPlatform.fuchsia:
        throw UnsupportedError(
          'لا إعدادات Firebase لـ$defaultTargetPlatform في تطبيق الزبون.',
        );
    }
  }
  ...
  static const FirebaseOptions android = FirebaseOptions(
    ...
    appId: '1:276428851477:android:2bef2c78bfdc381195811c',
  ...
  static const FirebaseOptions ios = FirebaseOptions(
    ...
    appId: '1:276428851477:ios:aee09a897eb6fdbd95811c',
    messagingSenderId: '276428851477',
    projectId: 'aqua-go-7cdd9',
    storageBucket: 'aqua-go-7cdd9.firebasestorage.app',
    iosBundleId: 'jo.aquago.customer',
  );
}

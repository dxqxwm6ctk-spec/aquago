...
class AquaColors extends ThemeExtension<AquaColors> {
  ...
  /// تدرّج الأزرار الأساسية (اطلب الآن، تأكيد، إلخ).
  ...
  /// تدرّج البطاقات البارزة (ملخّص الطلب، الرصيد...).
  ...
  /// تدرّج بطاقة المنتج (قارورة المياه).
  static const productGradient = LinearGradient(
    begin: Alignment(-1, -1),
    end: Alignment(1, 1),
    colors: [Color(0xFFF0FBFF), Color(0xFF7DD3FC), Color(0xFF38BDF8)],
    stops: [0, 0.62, 1],
  );

...
class ApiClient {
  ...
  /// نداءٌ يردّ **مصفوفة** لا كائناً (الكتالوج، العناوين، الطلبات).
  ///
  /// `_decode` يلفّ المصفوفة في `{'data': […]}` لتوحيد نوع الإرجاع، وقارئها
  /// كان عليه أن يعرف تلك التفصيلة الداخلية ويفكّها بنفسه في كل موضع —
  /// وينساها في واحد فيقرأ قائمةً فارغة بلا خطأ.
